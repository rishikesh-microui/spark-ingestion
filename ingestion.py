...
class SourceProbe:
    @staticmethod
    def _count_query(dialect, base_from_sql, incr_col, is_int_epoch, wm_lit, wm_hi_lit=None):
    ...
    @staticmethod
    def estimate_count(spark, jdbc, base_from_sql, incr_col, is_int_epoch, wm_lit, wm_hi_lit=None):
        q = SourceProbe._count_query(jdbc.get("dialect", "oracle").lower(),
                                     base_from_sql, incr_col, is_int_epoch, wm_lit, wm_hi_lit)
